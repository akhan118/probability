...
<body id="page-top">
    ...
    <header style="background-image: url('assets/img/bg-header.jpg');">
        <div class="intro-content">
            ...
            <div class="brand-name">Probability</div>
            <hr class="colored">
            <div class="brand-name-subtext">Detroit, Michigan</div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-lg-12 wow fadeIn">
                    <h1>E-commerce &amp; Enterprise Applications solutions</h1>
                    <p>In a world full of odds, Probability deliver certainty .</p>
                    <hr class="colored">
                </div>
            </div>
    ...
    <span class="btn btn-block btn-full-width"></span>
...
<!-- 
 ...
 -->
<!-- 
                    <p><a href="mailto:mail@example.com">ahmad@probability.ninja</a>
 -->
                    </p>
                </div>
            </div>
            ...
            <div class="row copyright">
                <div class="col-lg-12">
                    <p class="small">&copy; 2016 Probability L.L.C</p>
                </div>
            </div>
        </div>
    </footer>
